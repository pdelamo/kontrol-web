...
La web de una página de Kontrol («Kontrol» es nombre provisional), servida en `kontrol.delamotech.es`
...
Antes, en el DNS de delamotech.es (Hostinger): registro **A** `kontrol` → `187.124.113.210`.
